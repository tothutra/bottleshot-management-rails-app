...
ActiveRecord::Schema.define(version: 20161028182316) do

  create_table "add_on_bottleshots", force: :cascade do |t|
    t.integer  "add_on_id"
  ...
  create_table "bottleshots", force: :cascade do |t|
    t.string   "varietal"
    t.integer  "user_id"
    t.string   "status",          default: "open order"
    t.datetime "created_at",                             null: false
    t.datetime "updated_at",                             null: false
    t.integer  "vintage"
  ...
  create_table "glass_colors", force: :cascade do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  ...
  create_table "label_finishes", force: :cascade do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
  ...
  create_table "paperstocks", force: :cascade do |t|
    t.string   "name"
    t.string   "description"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
